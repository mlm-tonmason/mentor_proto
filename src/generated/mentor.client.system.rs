...
pub mod system_service_server {
    ...
    pub trait SystemService: std::marker::Send + std::marker::Sync + 'static {
        ...
        async fn get_config(
            ...
            tonic::Response<super::super::super::types::identity::SystemConfig>,
            tonic::Status,
        >;
        ...
        type StreamExchangeRatesStream: tonic::codegen::tokio_stream::Stream<
                Item = std::result::Result<
                    super::super::super::types::identity::ExchangeRate,
                    tonic::Status,
                >,
            >
            + std::marker::Send
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                "/mentor.client.system.SystemService/GetConfig" => {
                    ...
                    for GetConfigSvc<T> {
                        type Response = super::super::super::types::identity::SystemConfig;
