...
pub struct TelegramAuthRequest {
    ...
    #[prost(string, tag = "6")]
    pub auth_date: ::prost::alloc::string::String,
    #[prost(string, tag = "7")]
...
pub mod auth_service_server {
    ...
    pub trait AuthService: std::marker::Send + std::marker::Sync + 'static {
        /// Login using Telegram Widget data (Lazy Registration)
        async fn login(
            &self,
            request: tonic::Request<super::TelegramAuthRequest>,
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                "/mentor.client.auth.AuthService/Login" => {
                    ...
                    impl<
                        T: AuthService,
                    > tonic::server::UnaryService<super::TelegramAuthRequest>
                    for LoginSvc<T> {
