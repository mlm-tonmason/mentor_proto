...
pub struct LoginRequest {
    #[prost(oneof = "login_request::Credentials", tags = "1, 2")]
    pub credentials: ::core::option::Option<login_request::Credentials>,
}
...
pub mod login_request {
    ...
    pub enum Credentials {
        ...
        #[prost(string, tag = "1")]
        TelegramInitData(::prost::alloc::string::String),
        /// Для разработки: статический токен.
        #[prost(string, tag = "2")]
        DevToken(::prost::alloc::string::String),
    }
}
        ...
        B::Error: Into<StdError> + std::marker::Send + 'static,
    {
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                ...
                "/mentor.client.auth.AuthService/RefreshToken" => {
                    #[allow(non_camel_case_types)]
