...
### 1. Память Бота и Настройки (Bot Memory)

### 1.1 Общая Память (Shared Context)
Система работает с двумя типами памяти:
1.  **BotUserMemory**: Структурированные "факты" о человеке (заполняет LLM).
2.  **BotUserKVMemory**: Плоские настройки (заполняет Клиент/Бот).
